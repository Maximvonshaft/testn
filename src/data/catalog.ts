...
export const systems: readonly SystemVisual[] = [
  systemVisual('bathroom', '56% 50%'),
  systemVisual('interior', '66% 50%'),
  systemVisual('kitchen', '62% 50%'),
  systemVisual('hospitality', '68% 50%'),
  systemVisual('furniture', '64% 50%'),
  systemVisual('exterior', '64% 50%'),
] as const;
